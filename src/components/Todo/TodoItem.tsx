...
import { GetMyTodosQuery, Todos, ToggleTodoMutation, ToggleTodoMutationVariables, RemoveTodoMutationFn } from '../../generated/graphql';
...
const TodoItem = ({ index, todo }: TodoItemType) => {
  ...
  const removeTodo = (e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
    todoRemove({ variables: { id: todo.id } });
  };
